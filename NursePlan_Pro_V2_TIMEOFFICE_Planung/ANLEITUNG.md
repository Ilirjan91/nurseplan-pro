...
- die intelligente **V2-Planung mit Google OR-Tools**, die alle aktiven Regeln gemeinsam optimiert
...
2. Aktiviere unter **Grundregeln** nur die Regeln, die für deinen Bereich gelten.
   Für Nachtdienste kannst du zusätzlich die Mindestlänge eines Nachtblocks und
   die freien Tage nach dem vollständigen Block festlegen.
...
Im Bereich **Dienstplan → Neuer Monat** kannst du anschließend zwischen
**Klassisch planen** und **✨ Intelligent planen (V2)** wählen. V2 kann je nach
Teamgröße bis zu etwa 20 Sekunden rechnen und zeigt nicht lösbare Besetzungen
anschließend als Hinweis an.

Gespeicherter Urlaub sperrt für die automatische Planung immer den vollständigen
Zeitraum. Liegt ein Wochenende zwischen zwei Urlaubstagen, darf dort kein Dienst
vergeben werden. Als bezahlte Urlaubsstunden zählen weiterhin nur die regulären
Arbeitstage.
